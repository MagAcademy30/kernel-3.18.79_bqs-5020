...
//#define ALSPS_IOCTL_PS_CALI_START			_IOW(ALSPS, 0x19, int[2])
//#define ALSPS_IOCTL_PS_SET_CALI			_IOW(ALSPS, 0x1A, int[2])
//#define ALSPS_IOCTL_PS_GET_CALI			_IOW(ALSPS, 0x1B, int[2])
//#define ALSPS_IOCTL_PS_CLR_CALI			_IO(ALSPS, 0x1C)
//#define ALSPS_IOCTL_PS_CALI_RAW_DATA				_IOR(ALSPS, 0x1D, int)

#define ALSPS_IOCTL_PS_CALI_START			ALSPS_PS_ENABLE_CALI
#define ALSPS_IOCTL_PS_SET_CALI			ALSPS_IOCTL_SET_CALI
#define ALSPS_IOCTL_PS_GET_CALI			ALSPS_IOCTL_GET_CALI
#define ALSPS_IOCTL_PS_CLR_CALI			ALSPS_IOCTL_CLR_CALI
#define ALSPS_IOCTL_PS_CALI_RAW_DATA				ALSPS_GET_PS_RAW_DATA


//LINE<JIRA_ID><DATE20140217><wallpaper check for ms color>zenghaihui
#if 0 // def TINNO_MS_COLOR_SELECT
#define ALSPS_IOCTL_PHONE_COLOR_SET_CALI			_IOW(ALSPS, 0x1E, int[2])
#endif
