 ...
 ***************************/
#ifdef CONFIG_GPU_OC
#define GPU_DVFS_FREQ0     (816000)	/* KHz */
#define GPU_DVFS_FREQ1     (632000)	/* KHz */
#define GPU_DVFS_FREQ2     (500500)	/* KHz */
#define GPU_DVFS_FREQ3     (416000)	/* KHz */
#define GPU_DVFS_FREQ4     (300300)	/* KHz */
#define GPU_DVFS_FREQ5     (214500)	/* KHz */
#else
...
#endif
#ifdef CONFIG_GPU_OC
#define GPU_DVFS_FREQ6     (107250)	/* KHz */
#define GPU_DVFS_FREQ7     (90000)	/* KHz */
...
static struct mt_gpufreq_table_info mt_gpufreq_opp_tbl_e1_0[] = {
	...
	GPUOP(GPU_DVFS_FREQ7, GPU_DVFS_VOLT0),
#endif
};
